...
The source code is licensed under the [MIT License](LICENSE). This license does
not grant rights to third-party geospatial data, generated datasets, basemap
tiles, fonts, or model artifacts. See [DATA_LICENSE.md](DATA_LICENSE.md).
